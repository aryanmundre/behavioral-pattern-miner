    ...
    <div className="app">
      <header className="app-header">
        <div className="header-content">
          <h1>
            Maqro
            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="key-icon">
              ...
              <path d="M17.8851 8.29353C17.8851 9.50601 16.8982 10.4889 15.6807 10.4889C14.4633 10.4889 13.4763 9.50601 13.4763 8.29353C13.4763 7.08105 14.4633 6.09814 15.6807 6.09814C16.8982 6.09814 17.8851 7.08105 17.8851 8.29353Z" stroke="#1d1d1f" strokeWidth="1.5"/>
            </svg>
          </h1>
